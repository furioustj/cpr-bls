    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            >
              ...
              <div>
                <h2 className="font-bold text-xl">{APP_NAME}</h2>
                <p className="text-xs text-gray-400">CPR/BLS Training & Certification</p>
              </div>
            </motion.div>
            <motion.p 
              ...
              variants={itemVariants}
            >
              Providing professional CPR and Basic Life Support training with AHA certified instructors.
              Our mission is to equip individuals with the skills and confidence to respond effectively in emergency situations.
            </motion.p>
            <motion.div 
              className="flex space-x-4"
              variants={itemVariants}
            >
              <a href="https://www.facebook.com/Rescue.federation.air.ambulance.india/" className="p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="http://www.x.com/rescuefed" className="p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="http://www.instagram.com/therescuefederation/?hl=en" className="p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://www.linkedin.com/company/the-rescue-federation/" className="p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors duration-300">
          ...
          >
            ...
            <ul className="space-y-2">
              {[
                ...
                "Private Helicopter Air Ambulance",
                "Medical Tourism"
              ].map((course, index) => (
                <motion.li 
                  key={index}
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                Magre Tower, 2nd floor Ajantha Road
                Aurangabad, Maharashtra 431008
                </div>
              </motion.li>
              <motion.li 
                className="flex items-start"
              ...
              >
                ...
                <div className="text-gray-400">
                  hr@rescuefederation.com
                  support@rescuefederation.com
                </div>
              </motion.li>
            </ul>
          </motion.div>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
        >
          <p>&copy; {currentYear} © Copyright 2025. The Rescue Federation. All Rights Reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
